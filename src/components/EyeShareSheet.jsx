...
// Bottom-sheet share for an Eye Training question. Mirrors ShareSheet
// (cards) but formats text from a question round.

function buildShareText(round) {
  return `Eye Training · ${round.topic}\n\n${round.prompt}\n\nAnswer: ${round.correct}\n${round.why}\n\n— Almost, Type.`
}

export default function EyeShareSheet({ round, onClose }) {
    ...
    >
      ...
      >
        ...
        <div className="px-5 pt-2 pb-5">
          <div className="text-xs font-mono uppercase tracking-widest text-muted mb-1">Share question</div>
          <div className="font-serif font-semibold text-lg leading-snug text-ink mb-4">{round.prompt}</div>
